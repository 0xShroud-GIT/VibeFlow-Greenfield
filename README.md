...
M-001 through M-011 are accepted and `DONE` after independent verification and merge. The sole ready mission is `M-012` (Implement Project authority), in `READY`. M-013 and later missions remain `LOCKED` and remain required for V1.
