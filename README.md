...
M-001 through M-013 are accepted and `DONE` after independent verification and merge. The sole active mission is `M-014` (Implement imports/templates lifecycle), in `READY`. M-015 and later missions remain `LOCKED` and remain required for V1.
