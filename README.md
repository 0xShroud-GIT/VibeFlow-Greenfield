...
M-001 through M-014 are accepted and `DONE` after independent verification and merge. The sole active mission is `M-015` (Implement project lifecycle E2E), in `READY`. M-016 and later missions remain `LOCKED` and remain required for V1.
