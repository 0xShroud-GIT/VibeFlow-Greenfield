...
M-001 through M-012 are accepted and `DONE` after independent verification and merge. The sole active mission is `M-013` (Implement Artifact/ArtifactRelation), in `REVIEW`. M-014 and later missions remain `LOCKED` and remain required for V1.
