...
M-001 through M-010 are accepted and `DONE` after independent verification and merge. The sole active mission is `M-011` (Implement audit baseline), in `REVIEW`. M-012 and later missions remain `LOCKED` and remain required for V1.
