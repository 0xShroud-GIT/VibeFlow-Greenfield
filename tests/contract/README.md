...
- `test_m007_local_dev.py` — M-007 dev-environment adversarial suite: floating/malformed image refs, lock/provenance mismatch, wrong Node/pnpm versions, frozen-lockfile bypass, root user, privileged/host-network/Docker-socket/Docker-in-Docker, raw secrets, forwarded ports, product services, mission/ledger/hash drift, capability overclaim, plus positive active-snapshot and synthetic durable-extension passes.
